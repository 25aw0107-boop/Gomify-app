...
export default function DashboardScreen() {
  ...
  return (
    <View style={styles.mainWrapper}>
      {/* ScrollView ထည့်လိုက်လို့ Screen ပိတ်ညှပ်နေတဲ့ ပြဿနာ ရှင်းသွားပါပြီ */}
      <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
        
        {/* Image Background အစား ပုံမရှိရင်ပါ အလုပ်လုပ်မယ့် သန့်ရှင်းတဲ့ Container ပြောင်းထားပါတယ် */}
        ...
        <View style={styles.contentBody}>
          ...
          <View style={styles.reuseContainer}>
            ...
            <Pressable style={styles.listingButton} onPress={() => router.push('/modal')}>
        ...
        {/* Bottom nav အတွက် နေရာလွတ် ချန်ထားခြင်း */}
...
const styles = StyleSheet.create({
  ...
  container: { flex: 1 },
  heroBackground: { height: 200, backgroundColor: '#E2EFE0', paddingTop: 60, paddingHorizontal: 24, borderBottomLeftRadius: 30, borderBottomRightRadius: 30 },
  welcomeTextContainer: { marginTop: 20, justifyContent: 'center' },
  welcomeText: { fontSize: 22, fontWeight: 'bold', color: '#000', lineHeight: 32 },
  contentBody: { marginTop: 20, gap: 20 },
  taskCard: { backgroundColor: '#fff', borderRadius: 30, paddingVertical: 16, paddingHorizontal: 20, flexDirection: 'row', alignItems: 'center', marginTop: -40, marginHorizontal: 24, shadowColor: '#000', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.08, shadowRadius: 8, elevation: 3 },
  iconContainer: { marginRight: 12 },
  taskTextContainer: { flex: 1 },
  taskTitle: { fontSize: 18, fontWeight: 'bold', color: '#000', marginBottom: 4 },
  ...
  cardLeft: { flex: 1, height: 140, backgroundColor: '#fff', borderRadius: 24, padding: 18, shadowColor: '#000', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.06, shadowRadius: 6, elevation: 2 },
  cardRight: { flex: 1, height: 140, backgroundColor: '#fff', borderRadius: 24, padding: 18, shadowColor: '#000', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.06, shadowRadius: 6, elevation: 2, justifyContent: 'center' },
  cardTitle: { fontSize: 16, fontWeight: 'bold', color: '#000', marginBottom: 12 },
  cardContentRow: { flexDirection: 'row', alignItems: 'center', gap: 8 },
  cardDateText: { fontSize: 14, color: '#333', fontWeight: '500' },
  cardHeaderRow: { flexDirection: 'row', justifyBox: 'space-between', alignItems: 'center', marginBottom: 4 },
  progressContainer: { alignItems: 'center', justifyContent: 'center' },
  progressCircle: { width: 65, height: 65, borderRadius: 35, borderWidth: 5, borderColor: '#76C800', alignItems: 'center', justifyContent: 'center' },
  ...
  itemCard: { width: 160, height: 130, backgroundColor: '#EAE8E0', borderRadius: 12 },
  ...
  tabBarContent: { flexDirection: 'row', justifyBox: 'space-around', alignItems: 'flex-end', paddingBottom: 5, height: 95, zIndex: 2 },
