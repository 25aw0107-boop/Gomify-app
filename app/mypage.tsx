...
export default function MyPage() {
  ...
  const animatedWidth = animatedPoints.interpolate({
  ...
  const getThemeColors = () => {
    return {
      ...
      border: isNight ? '#9288da' : isKawaii ? '#E0E0E0' : isCafe ? '#573e19' : '#E0E0E0',
      borderWidth: isNight ? 5 : 0,
    ...
    <View style={[styles.mainWrapper, { backgroundColor: themeColors.bg }]}>
      ...
      <View style={[styles.container, { backgroundColor: themeColors.bg }]}>
        ...
        >
          ...
          >
            <View style={styles.userInfo}>
              <View style={styles.avatarWrapper}>
                <TouchableOpacity
                  style={[styles.avatar, { backgroundColor: themeColors.innerBg }]}
                  onPress={pickImage}
                  activeOpacity={0.7}
                >
                  {profileImage ? (
                ...
                <TouchableOpacity
                  style={[styles.cameraIconBadge, { borderColor: themeColors.border }]}
                  onPress={pickImage}
                  activeOpacity={0.8}
                >
              ...
              <View style={styles.userDetails}>
                {isProfileLoading ? (
                  ...
                  <>
                    ...
                    <ThemedText
                      type="default"
                      style={[styles.userLocation, { color: themeColors.subText }]}
                    >
                      📍 {userLocation}
                    </ThemedText>
                    <ThemedText
                      type="default"
                      style={[styles.userIntro, { color: themeColors.subText }]}
                      numberOfLines={2}
                    >
                      {userIntro}
                    </ThemedText>
            ...
            >
              <ThemedText type="default" style={[styles.profileBtnText, { color: themeColors.text }]}>
                プロフィール設定
              </ThemedText>
            </TouchableOpacity>
          </View>
          ...
          >
            <View style={styles.sectionTitle}>
              <ThemedText type="default" style={styles.sectionIcon}>
                💎
              </ThemedText>
              <ThemedText type="default" style={[styles.sectionLabel, { color: themeColors.text }]}>
                あなたのポイント
              </ThemedText>
            </View>
            <View style={styles.pointsInfo}>
              <ThemedText
                ...
                style={[styles.pointsValue, { color: themeColors.text }]}
              >
                {displayPoints}/{maxPoints} Pt
              </ThemedText>
              ...
              <ThemedText
                type="default"
                style={[styles.percentage, { color: themeColors.subText }]}
              >
                {Math.round((displayPoints / maxPoints) * 100)}%
              </ThemedText>
            </View>
          </View>
          ...
          >
            ...
            {/* 修改主题折叠 */}
            <View
              style={[styles.expandableContainer, { backgroundColor: themeColors.innerBg }]}
            >
              <TouchableOpacity
              ...
              >
                <View style={styles.expandBtnContent}>
                  ...
                  <View style={styles.expandBtnText}>
                    <ThemedText
                      type="defaultSemiBold"
                      style={[styles.expandBtnLabel, { color: themeColors.text }]}
                    >
                      デザインを変える
                    </ThemedText>
                    <ThemedText
                      type="default"
                      style={[styles.expandBtnSubtext, { color: themeColors.subText }]}
                    >
                      アプリのデザインをカスタマイズできます
                    </ThemedText>
                  </View>
              ...
              {expandedSections.design && (
                <View
                  style={[
                    ...
                    {
                      backgroundColor: themeColors.innerBg,
                  ...
                  {designModes.map((mode) => {
                    ...
                    return (
                      <TouchableOpacity
                        ...
                        activeOpacity={0.7}
                      >
                        <ThemedText type="default" style={styles.designOptionIcon}>
                          {mode.icon}
                        </ThemedText>
                        <ThemedText
                          type="default"
                        ...
                        {selectedDesign === mode.id ? (
                          <View style={styles.selectedBadge}>
                            <ThemedText type="default" style={styles.selectedBadgeText}>
                              選択中
                            </ThemedText>
                          </View>
                        ) : isUnlocked ? (
                          <ThemedText
                            type="default"
                            style={[styles.designOptionCost, { color: themeColors.subText }]}
                          >
                            着せ替える
                          </ThemedText>
                        ) : (
              ...
              {expandedSections.display && (
                ...
                >
                  ...
                  >
                    ...
                    >
                      リユースページでは、5ポイントを使って出品を優先表示にすることができます。
                    </ThemedText>
                  </TouchableOpacity>
                </View>
              )}
          ...
          >
            <View>
              ...
              >
                ...
                <ThemedText
                  type="default"
                  style={[styles.menuLabel, { color: themeColors.text }]}
                >
                  Gomifyについて
                </ThemedText>
                <MaterialCommunityIcons
                  name={expandedSections.about ? 'chevron-up' : 'chevron-right'}
                  size={16}
                  color={themeColors.subText}
                />
              </TouchableOpacity>
              {expandedSections.about && (
                <View style={[styles.menuContent, { backgroundColor: themeColors.innerBg }]}>
                  <ThemedText
                    type="defaultSemiBold"
                    style={[styles.menuContentTitle, { color: themeColors.text }]}
                  >
                    Gomifyについて
                  </ThemedText>
                  <ThemedText
                    type="default"
                    style={[styles.menuContentText, { color: themeColors.subText }]}
                  >
                    Gomify（ゴミファイ）は、一人暮らしを始めた方や、日本のゴミ分別に慣れていない方のためのアプリです。快適でエコな生活をサポートします。
                    {'\n'}
                    主な機能： ゴミカレンダー：ゴミ出しの日が一目で分かります。
            ...
            <View>
              <TouchableOpacity style={styles.menuBtn} activeOpacity={0.6} onPress={handleLogout}>
                ...
                <ThemedText
                  type="default"
                  style={[styles.menuLabel, { color: '#D9383A', fontWeight: '500' }]}
                >
                  ログアウト
                </ThemedText>
              </TouchableOpacity>
        ...
        <View style={styles.tabBarContainer}>
          <View
            style={[styles.tabBarBackground, { backgroundColor: themeColors.tabBarBgColor }]}
          />
          <View style={styles.tabBarContent}>
            <Pressable style={styles.tabItem} onPress={() => router.push('/dashboard')}>
              <View style={[styles.tabIconCircle, isHomeActive && styles.tabIconCircleActive]}>
                <Octicons
                  name="home"
                  size={24}
                  color={isHomeActive ? themeColors.tabActiveColor : themeColors.tabInactiveColor}
                />
              </View>
              <ThemedText
                style={[
                  ...
                  {
                    color: isHomeActive
                      ? themeColors.tabActiveColor
                      : themeColors.tabInactiveColor,
                  },
                ]}
              >
                ホーム
            ...
            <Pressable style={styles.tabItem} onPress={() => router.push('/calendar')}>
              <View style={[styles.tabIconCircle, isCalendarActive && styles.tabIconCircleActive]}>
                <FontAwesome5
                  ...
                  size={22}
                  color={
                    isCalendarActive ? themeColors.tabActiveColor : themeColors.tabInactiveColor
                  }
                />
              </View>
              <ThemedText
            ...
            <View style={styles.scanWrapper}>
              <Pressable
                style={[styles.scanButton, isScanActive && styles.tabIconCircleActive]}
                onPress={() => router.push('/scan')}
              >
                <Ionicons
                  name="scan-outline"
                  size={26}
                  color={isScanActive ? themeColors.tabActiveColor : themeColors.tabInactiveColor}
                />
              </Pressable>
              <ThemedText
                style={[
            ...
            <Pressable style={styles.tabItem} onPress={() => router.push('/reuse')}>
              <View style={[styles.tabIconCircle, isReuseActive && styles.tabIconCircleActive]}>
                <Ionicons
                  ...
                  size={26}
                  color={isReuseActive ? themeColors.tabActiveColor : themeColors.tabInactiveColor}
                />
              </View>
              <ThemedText
                style={[
            ...
            <Pressable style={styles.myPageItem} onPress={() => router.push('/mypage')}>
              <View
                style={[
                  ...
                  isMyPageActive && styles.tabIconCircleActiveMyPage,
                ]}
              >
                <Ionicons
                  name="person"
                  size={22}
                  color={isMyPageActive ? themeColors.tabActiveColor : themeColors.tabInactiveColor}
                />
              </View>
              <ThemedText
                style={[
          ...
          <View style={styles.supportModalContent}>
            ...
            >
              {isSubmittingTicket ? (
                ...
                <ThemedText style={styles.supportSubmitButtonText}>送信する</ThemedText>
              )}
            </TouchableOpacity>
          </View>
        </View>
          ...
          <View style={styles.supportModalContent}>
            ...
            <TouchableOpacity
              style={[
                ...
                { backgroundColor: '#D9383A', shadowColor: '#D9383A' },
                isSubmittingTicket && { opacity: 0.7 },
              ]}
            ...
            >
              {isSubmittingTicket ? (
                ...
                <ThemedText style={styles.supportSubmitButtonText}>報告する</ThemedText>
              )}
            </TouchableOpacity>
          </View>
        </View>
      ...
      >
        <View style={styles.modalOverlay}>
          <View style={styles.logoutModalContent}>
            ...
            <ThemedText type="defaultSemiBold" style={styles.logoutModalTitle}>
              ログアウト
            </ThemedText>
            <ThemedText type="default" style={styles.logoutModalText}>
              本当にログアウトしてもよろしいですか？
            </ThemedText>
            ...
            <View style={styles.logoutButtonGroup}>
              <TouchableOpacity
                ...
                activeOpacity={0.7}
              >
                <ThemedText type="defaultSemiBold" style={styles.logoutButtonTextCancel}>
                  キャンセル
                </ThemedText>
              </TouchableOpacity>
              <TouchableOpacity
                ...
                activeOpacity={0.7}
              >
                <ThemedText type="defaultSemiBold" style={styles.logoutButtonTextConfirm}>
                  ログアウト
                </ThemedText>
              </TouchableOpacity>
            </View>
...
const styles = StyleSheet.create({
  ...
  themeIcon: { marginBottom: 12 },
  themeTitle: { fontSize: 22, fontWeight: '700', color: '#333', marginBottom: 10 },
  themeText: { fontSize: 15, color: '#666', textAlign: 'center', marginBottom: 22 },
  themeButton: {
  ...
  themeButtonText: { color: '#fff', fontWeight: '700', fontSize: 16 },
  ...
  supportSubmitButtonText: { fontSize: 15, color: '#FFFFFF', fontWeight: '600' },
